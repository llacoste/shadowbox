...
def slice_cmd(
    ...
    width_mm: float = typer.Option(254.0, "--width-mm", help="Default 254mm = 10 inches."),
    height_mm: float = typer.Option(254.0, "--height-mm", help="Default 254mm = 10 inches."),
    kerf_mm: float | None = typer.Option(None, "--kerf-mm", help="Override the material preset's kerf."),
    min_feature_mm: float = typer.Option(12.7, "--min-feature-mm", help="Default 12.7mm = 0.5 inches."),
    margin_mm: float = typer.Option(0.0, "--margin-mm", help="Inset cuts and frame this many mm from the canvas edge."),
...
def project_save(
    ...
    min_feature_mm: float = typer.Option(12.7, "--min-feature-mm", help="Default 12.7mm = 0.5 inches."),
    margin_mm: float = typer.Option(0.0, "--margin-mm"),
